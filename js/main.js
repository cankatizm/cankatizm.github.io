...
var configs = (function () {
    ...
    Singleton.defaultOptions = {
        ...
        welcome: "Welcome to Cankat Aykurt's homepage (nerd and retrospective version).\nExecute the 'help' command for assistance or use more user-friendly menu at your left.",
...
var main = (function () {
    ...
    var cmds = {
		CV: { value: "cv", help: configs.getInstance().cv_help }, //edit
    ...
    var Terminal = function (prompt, cmdLine, output, sidenav, profilePic, user, host, root, outputTimer) {
        ...
        (typeof user === "string" && typeof host === "string") && (this.completePrompt = user + ":");
